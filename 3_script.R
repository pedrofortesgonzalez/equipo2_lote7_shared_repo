...
# Tenemos un df con alta dimensionalidad: vamos a pasarlo primero por métodos NSL para ver cómo se organizan los datos
...
## 2.1.ALGORITMOS DE REDUCCIÓN DE DIMENSIONALIDAD-------------------------------
### PCA-------------------------------------------------------------------------
#### Cálculos PCA --------------------------------------------------------------
...
## 4.4 EVALUACIÓN DE MÉTODOS SUPERVISADOS----------------------------------------
### CONF.MATRIX -----------------------------------------------------------------
#### RDA
...
### PERF.METRICS ---------------------------------------------------------------
#### Obtenidas de la matriz de confusión----------------------------------------
